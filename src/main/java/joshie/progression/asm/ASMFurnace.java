                ...
                return new MethodVisitor(Opcodes.ASM4, visitor) {
                    ...
                    public void visitMethodInsn(int opcode, String owner, String name, String desc, boolean itf) {
                        if (name.equals("getSmeltingResult") || (name.equals("a") && desc.equals("(Ladd;)Ladd;"))) {
                            ...
                            mv.visitMethodInsn(Opcodes.INVOKESTATIC, ProgressionInfo.ASMPATH + "helpers/CraftingHelper", "canUseItemForCrafting", "(L" + ProgressionInfo.ASMPATH + "crafting/ActionType;Lnet/minecraft/tileentity/TileEntity;Lnet/minecraft/item/ItemStack;)Z", false);
                            Label l4 = new Label();
                            ...
                            mv.visitMethodInsn(Opcodes.INVOKESTATIC, ProgressionInfo.ASMPATH + "helpers/CraftingHelper", "canCraftItem", "(L" + ProgressionInfo.ASMPATH + "crafting/ActionType;Lnet/minecraft/tileentity/TileEntity;Lnet/minecraft/item/ItemStack;)Z", false);
                            Label l5 = new Label();
