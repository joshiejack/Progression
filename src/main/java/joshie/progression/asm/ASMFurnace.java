                ...
                return new MethodVisitor(Opcodes.ASM4, visitor) {
                    ...
                    public void visitMethodInsn(int opcode, String owner, String name, String desc, boolean itf) {
                        if (name.equals("getSmeltingResult") || (name.equals("a") && desc.equals("(Ladd;)Ladd;"))) {
                            ...
                            Label l3 = new Label();
                            mv.visitLabel(l3);
                            mv.visitFieldInsn(Opcodes.GETSTATIC, ProgressionInfo.ASMPATH + "crafting/CraftingType", "FURNACE", "L" + ProgressionInfo.ASMPATH + "crafting/CraftingType;");
                            ...
                            mv.visitMethodInsn(Opcodes.INVOKESTATIC, ProgressionInfo.ASMPATH + "helpers/CraftingHelper", "canUseItemForCrafting", "(L" + ProgressionInfo.ASMPATH + "crafting/CraftingType;Lnet/minecraft/tileentity/TileEntity;Lnet/minecraft/item/ItemStack;)Z", false);
                            Label l4 = new Label();
                            ...
                            mv.visitMethodInsn(Opcodes.INVOKESTATIC, ProgressionInfo.ASMPATH + "helpers/CraftingHelper", "canCraftItem", "(L" + ProgressionInfo.ASMPATH + "crafting/CraftingType;Lnet/minecraft/tileentity/TileEntity;Lnet/minecraft/item/ItemStack;)Z", false);
                            Label l5 = new Label();
