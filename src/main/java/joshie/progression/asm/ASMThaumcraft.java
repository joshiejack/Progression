                ...
                if (name.equals("onCraftMatrixChanged") || name.equals("a") || name.equals("func_75130_a")) {
                    return new MethodVisitor(Opcodes.ASM4, visitor) {
                        ...
                        public void visitCode() {
                            ...
                            mv.visitVarInsn(Opcodes.ALOAD, 0);
                            mv.visitFieldInsn(Opcodes.GETFIELD, "thaumcraft/common/container/ContainerArcaneWorkbench", "tileEntity", "Lthaumcraft/common/tiles/crafting/TileArcaneWorkbench;");
                            mv.visitVarInsn(Opcodes.ALOAD, 0);
                            ...
                            mv.visitMethodInsn(Opcodes.INVOKESTATIC, "joshie/progression/asm/helpers/ThaumcraftHelper", "onContainerChanged", "(Lnet/minecraft/inventory/Container;Lthaumcraft/common/tiles/crafting/TileArcaneWorkbench;Lnet/minecraft/entity/player/InventoryPlayer;)V", false);
