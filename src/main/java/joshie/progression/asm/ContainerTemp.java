...
import joshie.progression.asm.helpers.VanillaHelper;
...
public class ContainerTemp extends Container
{
    ...
    public ContainerTemp(final InventoryPlayer playerInventory, boolean localWorld, EntityPlayer player)
    {
    ...
    {
        VanillaHelper.onContainerChanged(craftMatrix, craftResult, thePlayer.worldObj);
    }
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            if (index == 0)
            {
                ...
                TransferHelper.onPickup(this, slot, playerIn, itemstack);
            }
