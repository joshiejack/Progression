            ...
            if ((desc.equals("(Lnet/minecraft/inventory/InventoryCrafting;Lnet/minecraft/world/World;)Lnet/minecraft/item/ItemStack;") && name.equals("findMatchingRecipe")) || (desc.equals("(Laae;Lahb;)Ladd;") && name.equals("a"))) {
                return new MethodVisitor(Opcodes.ASM4, visitor) {
                    ...
                    public void visitCode() {
                        ...
                        mv.visitMethodInsn(Opcodes.INVOKESTATIC, ProgressionInfo.ASMPATH + "crafting/RecipeHandler", "findMatchingRecipe", "(Lnet/minecraft/inventory/InventoryCrafting;Lnet/minecraft/world/World;)Lnet/minecraft/item/ItemStack;", false);
