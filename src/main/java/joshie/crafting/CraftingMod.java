...
import joshie.crafting.rewards.RewardResearchPoints;
...
import joshie.crafting.trigger.TriggerResearchPoints;
...
public class CraftingMod implements IFMLLoadingPlugin {
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		CraftingAPI.registry.registerRewardType(new RewardResearchPoints());
		...
		CraftingAPI.registry.registerTriggerType(new TriggerResearchPoints());
