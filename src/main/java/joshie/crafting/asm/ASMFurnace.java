					...
					@Override
					   public void visitMethodInsn(int opcode, String owner, String name, String desc, boolean itf) {
						if (name.equals("getSmeltingResult")) {
							...
							super.visitFieldInsn(Opcodes.GETSTATIC, "joshie/crafting/api/CraftingAPI", "tracker", "Ljoshie/crafting/api/IOwnerTracker;");
							super.visitVarInsn(Opcodes.ALOAD, 0);
							super.visitMethodInsn(Opcodes.INVOKEINTERFACE, "joshie/crafting/api/IOwnerTracker", "getOwner", "(Lnet/minecraft/tileentity/TileEntity;)Ljoshie/crafting/api/crafting/ICrafter;", true);
