                ...
                return new MethodVisitor(Opcodes.ASM4, visitor) {
                    ...
                    public void visitMethodInsn(int opcode, String owner, String name, String desc, boolean itf) {
                        if ((name.equals("onSlotChange") || name.equals("func_75220_a") || name.equals("a")) && !isDone) {
                            ...
                            mv.visitFieldInsn(Opcodes.GETSTATIC, "joshie/crafting/api/CraftingAPI", "registry", "Ljoshie/crafting/api/IRegistry;");
                            ...
                            mv.visitMethodInsn(Opcodes.INVOKEINTERFACE, "joshie/crafting/api/IRegistry", "fireTrigger", "(Lnet/minecraft/entity/player/EntityPlayer;Ljava/lang/String;[Ljava/lang/Object;)Z", true);
