                ...
                return new MethodVisitor(Opcodes.ASM4, visitor) {
                    ...
                    public void visitVarInsn(int opcode, int var) {
                        if (opcode == Opcodes.ASTORE && var == 11 && !thisOne) {
                            ...
                            mv.visitMethodInsn(Opcodes.INVOKESTATIC, CraftingInfo.ASMPATH + "asm/helpers/AutopackagerHelper", "getResult", "(Lnet/minecraft/tileentity/TileEntity;Lnet/minecraft/inventory/InventoryCrafting;Lnet/minecraft/item/ItemStack;)Lnet/minecraft/item/ItemStack;", false);
