            ...
            if (desc.equals("(I)Z") && name.equals("canTakeStack")) {
                return new MethodVisitor(Opcodes.ASM4, visitor) {
                    ...
                    public void visitCode() {
                        ...
                        mv.visitMethodInsn(Opcodes.INVOKESTATIC, CraftingInfo.ASMPATH + "asm/helpers/ForestryHelper", "canCraftRecipe", "(Lnet/minecraft/tileentity/TileEntity;Lforestry/core/inventory/TileInventoryAdapter;Lnet/minecraft/inventory/IInventory;Lforestry/factory/recipes/RecipeMemory$Recipe;I)Z", false);
